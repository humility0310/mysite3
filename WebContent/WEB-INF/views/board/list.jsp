			...
			<div id="board">
				...
				<table class="tbl-ex">
					...
					<tr>
						...
						<td>${vo.hit }</td>
						<td>${vo.reg_date }</td>
						<td><c:if test="${vo.users_no==authUser.no }"><a href="/mysite3/board?a=delete&no=${vo.no }" class="del">삭제</a></c:if></td>
				...
				<div class="bottom">
					<a href="/mysite3/board?a=writeform&board_no=nothing" id="new-book">글쓰기</a>
				</div>		</c:if>			
			</div>
		</div>
